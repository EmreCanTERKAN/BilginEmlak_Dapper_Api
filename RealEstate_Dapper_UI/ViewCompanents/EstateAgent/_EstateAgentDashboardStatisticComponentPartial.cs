...
namespace RealEstate_Dapper_UI.ViewCompanents.EstateAgent
{
    public class _EstateAgentDashboardStatisticComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44304/api/EstateAgentDashboardStatistic/ProductCountByEmployeeId?id=" + id);
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44304/api/EstateAgentDashboardStatistic/ProductCountByStatusTrue?id=" + id);
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:44304/api/EstateAgentDashboardStatistic/ProductCountByStatusFalse?id=" + id);
